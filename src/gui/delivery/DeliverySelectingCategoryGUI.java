...
public class DeliverySelectingCategoryGUI {
	...
	class SelectWay implements ActionListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			{
				case "Odbior osobisty":
					main.getClient().setWayOfDelivery(new Personal(main));
					break;
				case "Paczkomat":
					main.getClient().setWayOfDelivery(new ParcelLocker(main));
					break;
				case "Kurier":
					main.getClient().setWayOfDelivery(new DeliveryMan(main));
					break;
				default:
