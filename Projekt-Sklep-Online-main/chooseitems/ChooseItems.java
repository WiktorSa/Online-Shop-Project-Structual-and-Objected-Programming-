...
public class ChooseItems 
{
	...
	private Basket basket[]; // W koszyku beda zawarte informacje o kategorii, nazwie, cenie i ilosci produktu NOTE(Szymon): Wszystkie informacje sa zawarte w klasie
	...
	// Cena to wyjatkowo String!!! Wynika to z tego, ze array musi siê skladac z obiektow tego samego typu, NOTE(Szymon):Gdy mamy klase Product to mozna dac price jako double/float
